...
<head>
    ...
    <title>Accesso Pannello QoffeRun</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>Gentile gestore di <strong>{{ $barName }}</strong>,</p>
        
        <p>la informiamo che è stato effettuato un accesso al pannello di gestione QoffeRun con il suo account.</p>

        <div class="login-info">
            <h3 style="color: #0056b3; margin: 0 0 15px 0;">📋 Dettagli accesso</h3>
            <div class="info-row">
        ...
        <div class="security-info">
            ...
            <p style="color: #856404; margin: 0; line-height: 1.5;">
                Se non ha effettuato lei questo accesso, la preghiamo di contattare immediatamente il nostro supporto tecnico e di cambiare la password del suo account.
            </p>
        </div>
